...
@file:SuppressLint("ClickableViewAccessibility", "NotifyDataSetChanged")
...
import com.force.codes.mynotes.core.widget.swipeadater.listener.OnItemDragListener
import com.force.codes.mynotes.core.widget.swipeadater.listener.OnItemSwipeListener
import com.force.codes.mynotes.core.widget.swipeadater.util.DragDropSwipeDiffCallback
import com.force.codes.mynotes.core.widget.swipeadater.util.DragDropSwipeTouchHelper
import com.force.codes.mynotes.core.widget.swipeadater.util.drawHorizontalDividers
import com.force.codes.mynotes.core.widget.swipeadater.util.drawVerticalDividers
...
abstract class DragDropSwipeAdapter<T, U : DragDropSwipeAdapter.ViewHolder>(
    ...
    private val itemDragListener = object : DragDropSwipeTouchHelper.OnItemDragListener {
        override fun onItemDragged(previousPosition: Int, newPosition: Int) {
            ...
            dragListener?.onItemDragged(previousPosition, newPosition, item, finish)
        }
    ...
    private val itemSwipeListener = object : DragDropSwipeTouchHelper.OnItemSwipeListener {
        override fun onItemSwiped(position: Int, direction: OnItemSwipeListener.SwipeDirection) {
            ...
            if (swipeListener?.onItemSwiped(position, direction, item, isActiveTask) != true)
    ...
    private fun drawOnSwiping(
        ...
        recyclerView?.let { list ->
            ...
            val isSwipingHorizontally =
                (orientation.swipeFlagsValue and DragDropSwipeRecyclerView.ListOrientation.DirectionFlag.RIGHT.value == DragDropSwipeRecyclerView.ListOrientation.DirectionFlag.RIGHT.value)
