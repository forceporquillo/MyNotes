...
class CollapsibleCalendar @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : UICalendar(context, attrs, defStyleAttr), View.OnClickListener {
    ...
    fun select(day: Day) {
        ...
        if (mListener != null) {
            mListener!!.onDaySelect(this.selectedDay)
        }
    }
    ...
    interface CalendarListener {
        ...
        fun onDaySelect(selectedDay: Day?)
